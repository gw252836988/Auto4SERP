...
namespace Bll.Repair
{
    ...
    {
        void AddAccInD(string dh, string itemcode,string inprice,string amount);
        ...
        void UpdateAccInD(string dh, string xh, string amount, string InPrice, string accessorycode);
