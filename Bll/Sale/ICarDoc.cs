   ...
   public interface ICarDoc
    {
       ...
       bool AddCarModel(string carmodel, int carser_id,string id);
       ...
       DataTable GetCarDetailVById(int detailId);
       CarDetail GetCarDetailObjectById(int detailId);
       CarDetail GetCarDetailObjectByAutoNumber(string autonumber);

       DataSet GetCarDocAll();
       void UpdateCarPrice(string autonumber, double costprice, double saleprice, double directprice);
       string GetMaxZBH();
       decimal GetNewSalePrice(string autonumber);
       DataTable GetSalePricesOfYear(int year, string autonumber);
       DataTable GetCarDetailByPrice(string price);
       CarDetail GetCarDetailObjectByVin(string Vin);
       DataTable GetCarSerAndModels();
       string GetMaxCarModelID(int serID);
   }
}
