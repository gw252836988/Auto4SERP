...
namespace DBUtil
{
    public  class MSDBHelper
    {
       ...
       // }
        ...
        public MSDBHelper(string organID)
        {
           ...
           this.connection = new MySqlConnection(ConnectionStringFactory.getInstance().ReturnConnString(organID));
        ...
        {
          //  DbProviderFactory dbfactory = DbProviderFactories.GetFactory(MSDBHelper.dbProviderName);
            //DbConnection dbconn = dbfactory.CreateConnection();
        ...
        //执行事务#region 执行事务
        #region
        public DataSet ExecuteDataSet(DbCommand cmd, MSTrans t)
        {
        ...
        public DataTable ExecuteDataTable(DbCommand cmd, MSTrans t)
        {
            cmd.Connection = t.DbConnection;
            cmd.Transaction = t.DbTrans;
         //   DbProviderFactory dbfactory = DbProviderFactories.GetFactory(MSDBHelper.dbProviderName);
        ...
        public DbDataReader ExecuteReader(DbCommand cmd, MSTrans t)
        {
            cmd.Connection.Close();
            cmd.Connection = t.DbConnection;
            cmd.Transaction = t.DbTrans;
        ...
        public int ExecuteNonQuery(DbCommand cmd, MSTrans t)
        {
            cmd.Connection.Close();
            cmd.Connection = t.DbConnection;
            cmd.Transaction = t.DbTrans;
        ...
        public object ExecuteScalar(DbCommand cmd, MSTrans t)
        {
            cmd.Connection.Close();
            cmd.Connection = t.DbConnection;
            cmd.Transaction = t.DbTrans;
    ...
    public class MSTrans : IDisposable
    {
        ...
        //}
        public MSTrans(string connectionString)
        {
