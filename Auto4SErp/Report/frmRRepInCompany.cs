...
{
    public partial class frmRRepInCompany : ifrmBase
    {

        private IRepair mIRepair;
        public frmRRepInCompany()
        {
        ...
        private void frmRRepInCompany_Load(object sender, EventArgs e)
        {
        ...
        protected override void DoQuery()
        {
            ...
            DataTable dt;
            dt = mIRepair.GetRepInCompany(strBegin, strEnd);
