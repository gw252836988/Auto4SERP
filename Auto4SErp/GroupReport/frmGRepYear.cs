...
{
    public partial class frmGRepYear : ifrmBase
    {
        public frmGRepYear()
        {
            InitializeComponent();
        ...
        private void frmGRepYear_Load(object sender, EventArgs e)
        {
        ...
        private void DoSummary()
        {
            ...
            DataTable dt = (DataTable)dgRep.DataSource;
        ...
        private void btnOut_Click(object sender, EventArgs e)
        {
            ...
            eio.NewDTOutTo((DataGridView)dgRep);
        }
